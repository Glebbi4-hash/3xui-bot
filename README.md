...
| 📱 QR-код | QR для быстрого подключения в приложении |
| 📋 Инбаунды | Обзор всех инбаундов с суммарным трафиком |
| 🔑 Запрос доступа | Пользователь запрашивает доступ через бота, админ одобряет и выбирает инбаунд — клиент получает ссылку и QR |
| 🖥 Статистика сервера | CPU, RAM, диск, сеть, аптайм, топ процессов |
